...
import io.nity.grpc.sample.SampleClientSimpleApp;
...
@SpringBootTest(classes = SampleClientSimpleApp.class, webEnvironment = SpringBootTest.WebEnvironment.DEFINED_PORT)
