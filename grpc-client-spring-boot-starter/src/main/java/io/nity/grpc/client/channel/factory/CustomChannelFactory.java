...
/**
 * abstract ChannelFactory for custom model
 */
public abstract class CustomChannelFactory extends AbstractChannelFactory {

    public CustomChannelFactory(GrpcClientPropertiesMap clientPropertiesMap, GrpcChannelBuilderConfigurer channelBuilderConfigurer, GrpcChannelConfigurer channelConfigurer) {
